...
(**
    Functions for parsing vue programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a vue program from a string into a typed OCaml CST.
...
val string :
  ...
  (CST.component, CST.extra) Tree_sitter_run.Parsing_result.t

(** Parse a vue program from a file into a typed OCaml CST.
