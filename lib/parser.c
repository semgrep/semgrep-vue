...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [59] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_element_repeat1, 2), SHIFT_REPEAT(50),
  ...
  [251] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_element, 3),
  [253] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_start_tag, 3),
  [255] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_start_tag, 3),
  [257] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_start_tag, 4),
  [259] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_start_tag, 4),
  ...
  [273] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_template_element, 2),
  [275] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_template_element, 2),
  [277] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_erroneous_end_tag, 3),
  [279] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_erroneous_end_tag, 3),
  [281] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_interpolation, 3),
  [283] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpolation, 3),
  [285] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_element, 2),
  [287] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_element, 2),
  [289] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_element, 1),
  [291] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_element, 1),
  [293] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_directive_attribute, 3),
  [295] = {.entry = {.count = 1, .reusable = true}}, SHIFT(126),
  [297] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_directive_attribute, 3),
  [299] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_self_closing_tag, 4),
  [301] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_self_closing_tag, 4),
  [303] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_interpolation, 2),
  [305] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_interpolation, 2),
  [307] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_end_tag, 3),
  [309] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_end_tag, 3),
  [311] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_self_closing_tag, 3),
  [313] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_self_closing_tag, 3),
